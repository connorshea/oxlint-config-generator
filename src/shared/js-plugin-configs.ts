...
export const jsPluginConfigs: JSPluginConfig[] = [
  { name: "playwright", packageName: "eslint-plugin-playwright", rulePrefix: "playwright", label: "Playwright" },
  { name: "stylistic", packageName: "@stylistic/eslint-plugin", rulePrefix: "@stylistic", label: "Stylistic" },
  { name: "storybook", packageName: "eslint-plugin-storybook", rulePrefix: "storybook", label: "Storybook" },
  {
  ...
  { name: "cypress", packageName: "eslint-plugin-cypress", rulePrefix: "cypress", label: "Cypress" },
